...
current_version=$(grep -o "__version__ = version = '[0-9.]*'" src/automatyzer/_version.py | grep -o "[0-9.]*")
...
cat > src/automatyzer/_version.py << EOF
...
setup(
    ...
    author="automatyzer Team",
    author_email="info@automatyzer.com",
    url="https://github.com/automatyzer/python",
...
echo ""
git add src/automatyzer/_version.py setup.py "$changelog_file" increment_init.py increment_setup.py
...
rm -rf build/ dist/ src/automatyzer.egg-info/
